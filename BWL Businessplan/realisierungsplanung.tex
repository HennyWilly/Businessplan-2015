...
Steuerung der \produktname{} und der Firmware f"ur das Ger"at investieren.
...
Arbeit abnehmen und einen einfach zu bedienenden und voll individualisierbaren
Kaffeevollautomaten erstellen.
...
wollen wir zudem neue, mit NFC-Chips best"uckte Tassen verkaufen.
Diese sollen eventuell verschlissene Tassen ersetzen.
...
unsere \missingText{untersten Arbeitskr"afte} zu zahlen.
...
Um einen \missingText{Flop} des Produkts zu verhindern, werden so fr"uh wie
...
dass den W"unschen der potentiellen Kunden entspricht.

% Wie k"onnen Sie diese negativen Ereignisse eventuell schon im Vorfeld verhindern?}
Um nach der Entwicklung m"oglichst schnell mit Verk"aufen zu beginnen, werden
wir eine intensive Kundenakquise betreiben.
Die kommerziellen Kunden, wie z.B. Firmen, k"onnen dann ihren Kunden und
Mitarbeitern unser Produkt zur Verf"ugung stellen, damit deren Aufenthalt bzw.
